...
{{%note %}}
NOTE: we recommend installing an Ingress dedicated to TNC-O to avoid hostname and/or subpath clashes.
{{%/note %}}
...
{{%note %}}
NOTE: the choice of HTTPS vs HTTP protocol depends on whether TNC-O is installed with security enabled. This will be covered later in the configuration steps.
{{%/note %}}
