...
The example above shows the first message sent when an intent has been received by TNC-O. The processId will be used in all subsequent state change events. These happen when the process changes state.  
