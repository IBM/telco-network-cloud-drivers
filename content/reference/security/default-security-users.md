...
| RootSecAdmin             | 'Root Security Admin'. Only an authenticated TNC-O user with this role can create/update/delete role definitions within TNC-O and carry out other security admin tasks.<br>A user with only this role cannot perform any other operations within TNC-O. | <ul><li>User Credentials - CRUDE</li></ul>                                                                                                                                                                                                                                                                                |
