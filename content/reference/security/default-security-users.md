...
| RootSecAdmin             | 'Root Security Admin'. Only an authenticated LM user with this role can create/update/delete role definitions within TNCO and carry out other security admin tasks.<br>A user with only this role cannot perform any other operations within TNCO. | <ul><li>User Credentials - CRUDE</li></ul>                                                                                                                                                                                                                                                                                |
